...
function SSDP(opts, sock) {
  var self = this
  console.log("function SSDP called");
  ...
  if (!sock) {
	  console.log("no options, only socket");
...
SSDP.prototype._init = function (opts) {
  ...
  if (typeof opts.location === 'function') {
	...
	console.log(opts.location || 'http://' + ip.address() + ':' + 10295 + '/upnp/desc.html');
    this._location = opts.location || 'http://' + ip.address() + ':' + 10295 + '/upnp/desc.html'
  }
  ...
  console.log(this._ssdpServerHost);
  
  this._usns = {}
  this._udn = opts.udn || 'uuid:f40c2981-7329-40b7-8b04-27f187aecfc5'
	console.log(this._udn);
...
SSDP.prototype._getStatusCode = function _getStatusCode(msg) {
 ...
 console.log('statuscode ssdp: ' + code);
  return code
}
